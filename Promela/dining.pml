...
/* 
   ...
   Initialize in init process to symmetric or asymmetric configuration
   Verify Safety - invalid end state deadlocks for symmetric configuration
*/
...
init {
	atomic {
	  ...
	  /* Symmetric and non-symmetric programs */
 	  run Phil(4, forks[4], forks[0]);     /* Symmetric  */ 
/*    run Phil(4, forks[0], forks[4]);  */ /* Asymmetric */
	}
}
